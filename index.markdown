...
Almost every day, we can read about local crimes in the newspaper, and get so overwhelmed with the load of incidents, that it can be very hard to get the big picture of what is actually going on. On this page, we want to investigate and visualize incidents, where people were recorded driving under the influence (DUI) in San Francisco, by looking at the San Francisco Crime Dataset, that contains data from between 2003 and 2018.

There have been implementations of various initiatives aimed at reducing DUI incidents and improving road safety in San Francisco during the selected period. For instance in 2006, San Francisco initiated a program called "Avoid the 25" which involved law enforcement agencies across 25 cities and counties in area working together to fight drunk driving during holidays and special events. This program included increased DUI checkpoints, saturation patrols, and public awareness campaigns to discourage people from driving under the influence.

Furthermore, in 2010 San Francisco's Police Department received a grant from the California Office of Traffic Safety to enhance DUI enforcement efforts, which included funding for additional officers dedicated to DUI patrols and checkpoints. So there is a proactive approach by the city towards combating DUI incidents and promoting road safety. Nevertheless, it might be interesting to look at the data from a quantitative standpoint, to see specific characteristics and patterns in the occurrence of those incidents.
